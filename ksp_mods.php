                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row row-bottom-padded-sm animate-box">
                            ...
                            <div class="col-md-9">
                                <p class="fh5co-lead">
                                    Kerbal Space Program <sub>v</sub>1.11.2
                                    <br>
...
AlphaMensae's Modular Launch Pads (ModularLaunchPads 2.1.4)
...
Bluedog Design Bureau (BluedogDB v1.7.2-hotfix)
...
Custom Parachute Message (CustomParachuteMessage v1.0.0)
...
DSEV (DSEV v3.8.0)
DSEV CRP Play Mode (DSEV-PlayMode-CRP v3.8.0)
...
HullcamVDS Continued (HullcamVDSContinued 0.2.1)
...
Kerbal GPS (KerbalGPSRevived 1.2.1.1)
...
Kerbal Telemetry (KerbalTelemetry v2.1.0)
Kerbal Tubes (KerbalTubes 1.3.3.3)
Kerbalism (Kerbalism 3.13)
Kerbalism - Default Config (Kerbalism-Config-Default 3.13)
...
MechJeb 2 - DEV RELEASE (MechJeb2-dev 2.12.0.0-1044)
...
MOAR Station Science (MOARStationScience v2.6.0.3)
...
Near Future Propulsion - Xenon Hall Effect Thrusters (NearFuturePropulsion-XenonHETs 1.3.2)
...
Rational Resources (RationalResources 1.16.2)
...
Waterfall Core (Waterfall 0.6.2)
Where Can I Go (WhereCanIGo 2.1)
Wild Blue Tools (WildBlueTools v1.82.1)
WildBlueIndustries CRP Play Mode (WildBlue-PlayMode-CRP v1.82.1)
