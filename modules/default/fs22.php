<title>Farming Simulator 22 | <?php echo $siteName;?></title>
</head>
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row row-bottom-padded-sm animate-box">
                        ...
                        <div class="col-md-9">
                            Farming Simulator 22 <sub>v</sub>1.14 (34202/86489)<br><br>
                            <i class="fas fa-exclamation-triangle"></i> All the mods are been downloaded directly from <a href="https://www.farming-simulator.com/mods.php?lang=en&country=ca&title=fs2022&filter=latest&page=0"><i class="fas fa-tractor"></i></a> website, modhub from ingame or any other mods website.<br>
                            This list has been tested for multiplayer map with/without Seasons* mod.<br>
                            I play with more than >6000 mods.<br><br>
                            Loading Details:<br>
                            Booting Game Loading Screen 30s<br>
                            Entering on game map >12 minutes.<br>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            ...
                            <table class="table table-bordered table-dark fh5co-text-calendar" style="width: 60%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Traffic</td>
                                        <td><span style="color: green;"><i class="fas fa-power-off"></i></span></td>
                                    </tr>
                                    <tr>
                                        <td>Dirt</td>
                                        <td>Normal</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span style="color: red;"><i class="fas fa-power-off"></i></span></td>
                                    </tr>
                                    <tr>
                            ...
                            <p class="fh5co-lead">Crop and Growth</p>
                            <table class="table table-bordered table-dark fh5co-text-calendar" style="width: 60%">
                                <thead>
                                <tr>
                                    <th>Option</th>
                        ...
                        <div class="col-md-9">
                            <table class="table table-bordered table-dark fh5co-text-calendar" style="width: 80%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Multiplayer</th>
                        ...
                        <div class="col-md-9">
                            <p>The list will update if is exists modification/once on week and so on. You can download it: <a href="<?php echo BASE_HREF;?>files/fs22_mods.pdf"><i class="far fa-file-pdf"></i></a></p>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <p>
                                ...
                                After install go to settings and select <u>Archive Extractor</u> then on the right side disable <u>Extract archives after download</u> if is selected, because not need the mods to be extracted from archive.<br>
                                Download the list <a href="#"><i class="far fa-file-pdf"></i></a> and use Control + C, all links are going to jDownloader automatically.
                            </p>
                        </div>
                    </div>
                </div>
